...
public class InscriptionEvent extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//récupération de la session ( pour l'id utilisateur ), dont l'attribut est stoquée dans une variable 
		...
		/*Comme la method return un String, on déclare une nouvelle variable String initialié à l'instance du 
		 * controlleur.laMethod
		 */
